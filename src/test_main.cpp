...
TEST(TEST_HTML_TAG, start_tag) {
    ...
    if (strcmp(tag->value, "open") != 0)
        GTEST_FAIL() << "Wrong answer";
    tag++;
    if (strcmp(tag->name, "action") != 0)
        GTEST_FAIL() << "Wrong answer";
    if (strcmp(tag->value, "/questions/511196/answer/submit") != 0)
        GTEST_FAIL() << "Wrong answer";
    tag++;
    if (strcmp(tag->name, "class") != 0)
        GTEST_FAIL() << " Wrong answer";
...
TEST(TEST_HTML_TAG,  spechial_attr_tag) {
    ...
    if (strcmp(tag->name, "action") != 0)
        GTEST_FAIL() << "Wrong answer";
    if (strcmp(tag->value, "/search") != 0)
        GTEST_FAIL() << "Wrong answer";
    tag++;
    if (strcmp(tag->name, "class") != 0)
        GTEST_FAIL() << "Wrong answer";
    if (strcmp(tag->value, "post-form") != 0)
        GTEST_FAIL() << "Wrong answer";
}
