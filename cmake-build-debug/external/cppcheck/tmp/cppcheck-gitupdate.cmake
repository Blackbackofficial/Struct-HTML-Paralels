...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "1.79"
  WORKING_DIRECTORY "/Users/ivanchernov/CLionProjects/DZ1/cmake-build-debug/external/cppcheck/src"
...
if("${show_ref_output}" MATCHES "refs/remotes/1.79")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "1.79")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/danmar/cppcheck.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/ivanchernov/CLionProjects/DZ1/cmake-build-debug/external/cppcheck/src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/ivanchernov/CLionProjects/DZ1/cmake-build-debug/external/cppcheck/src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
