...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "release-1.10.0"
  WORKING_DIRECTORY "/Users/ivanchernov/CLionProjects/DZ1/cmake-build-debug/googletest-src"
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/ivanchernov/CLionProjects/DZ1/cmake-build-debug/googletest-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/ivanchernov/CLionProjects/DZ1/cmake-build-debug/googletest-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
